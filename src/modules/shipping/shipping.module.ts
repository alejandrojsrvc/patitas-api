...
import { SHIPPING_REPOSITORY, type ShippingRepository } from './domain/shipping.repository';
...
@Module({
  ...
  providers: [{ provide: SHIPPING_REPOSITORY, useClass: PrismaShippingRepository }, { provide: ShippingService, inject: [SHIPPING_REPOSITORY], useFactory: (repository: ShippingRepository) => new ShippingService(repository) }],
