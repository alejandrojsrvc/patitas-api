...
export class CreateCustomerAddressDto {
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(80) public apartment?: string | null;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(240) public reference?: string | null;
