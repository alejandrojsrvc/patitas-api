...
import { MARKETING_REPOSITORY, type MarketingEventRepository } from './domain/marketing.repository';
...
@Module({
  imports: [PrismaModule, MarketingInfrastructureModule, AuthModule, CustomersModule],
  ...
  providers: [
    ...
    { provide: MARKETING_REPOSITORY, useExisting: PrismaMarketingRepository },
    {
      ...
      useFactory: (repository: MarketingEventRepository, provider: MarketingProvider) => new MarketingService(repository, provider),
    },
  ],
