...
import type {
  CreateSupplierInput, CreateSupplierOfferInput, UpdateSupplierInput,
  UpdateSupplierOfferInput, SupplierFilter,
...
export class SupplierService {
  ...
  public listSuppliers(filter: SupplierFilter) { return this.repository.listSuppliers(filter); }
  ...
  public createSupplier(input: CreateSupplierInput) {
    ...
    return this.repository.createSupplier({ ...input, name: input.name.trim() });
  }
