...
import { CATALOG_REPOSITORY, type CatalogRepository } from './domain/repositories/catalog.repository';
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      inject: [CATALOG_REPOSITORY, STORAGE_PROVIDER, SupplierService, FulfillmentService, CATALOG_CACHE_INVALIDATION],
      useFactory: (
      ...
      ) => new CatalogService(repository, storage, supplierOffers, fulfillment, cacheInvalidation),
    },
    {
      provide: MobileCatalogService,
      inject: [CATALOG_REPOSITORY, CatalogService, PromotionService, ShippingService, CustomerService],
      useFactory: (
        repository: CatalogRepository,
