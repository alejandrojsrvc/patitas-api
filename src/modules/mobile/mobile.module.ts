...
import { MOBILE_ACCESS_REPOSITORY, type MobileAccessRepository } from '../../shared/application/ports/mobile-access.repository';
...
import { MOBILE_PAYMENT_METHOD_REPOSITORY, type MobilePaymentMethodRepository } from './domain/mobile-payment-method.repository';
...
@Module({
  imports: [PrismaModule, AuthModule, CustomersModule, PetsModule, CatalogModule, CheckoutModule, PaymentsModule],
  controllers: [
  ...
  providers: [
    ...
    },
    {
      ...
      useFactory: (repository: MobileAccessRepository) => new MobileAccessService(repository),
    },
    ...
    },
    {
      ...
      inject: [CheckoutService, CustomerAddressService, MOBILE_PAYMENT_METHOD_REPOSITORY],
      useFactory: (checkout: CheckoutService, addresses: CustomerAddressService, methods: MobilePaymentMethodRepository) =>
    ...
    },
    {
      ...
      useFactory: (payments: PaymentService, methods: MobilePaymentMethodRepository) => new MobilePaymentService(payments, methods),
    },
  ],
})
