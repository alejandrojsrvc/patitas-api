...
import { REFERRAL_REPOSITORY, type ReferralRepository } from './domain/referral.repository';
...
@Module({
  ...
  providers: [
    ...
    { provide: REFERRAL_REPOSITORY, useExisting: PrismaReferralRepository },
    {
      ...
      useFactory: (repository: ReferralRepository) => new ReferralService(repository),
    },
  ],
