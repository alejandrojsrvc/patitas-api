...
export class PromotionController {
  ...
  @Get('promotions') public list(@Query('active') active?: string) {
    return this.promotions.list(active === 'true');
  }
  @Get('promotions/:id') public find(@Param('id') id: string) {
    return this.promotions.find(id);
  }
  @Post('promotions') public create(@Body() input: CreatePromotionDto) {
    return this.promotions.create(input);
  }
  @Patch('promotions/:id') public update(@Param('id') id: string, @Body() input: UpdatePromotionDto) {
    return this.promotions.update(id, input);
  }
  @Get('coupons') public coupons() {
    return this.promotions.listCoupons();
  }
  @Post('coupons') public createCoupon(@Body() input: CreateCouponDto) {
    return this.promotions.createCoupon(input);
  }
  @Patch('coupons/:id') public updateCoupon(@Param('id') id: string, @Body() input: UpdateCouponDto) {
