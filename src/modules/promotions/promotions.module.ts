...
@Module({
  ...
  providers: [{ provide: PROMOTION_REPOSITORY, useClass: PrismaPromotionRepository }, { provide: PromotionService, inject: [PROMOTION_REPOSITORY], useFactory: (repository: PromotionRepository) => new PromotionService(repository) }],
